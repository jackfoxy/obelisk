...
++  gen3-file-my-table-3
  [p=[%dbo %my-table-3] q=[%file ship=~zod agent='/test-agent' tmsp=~2030.1.1 clustered=%.y length=2 column-lookup=col-lu-table-3 key=~[[%t %.y] [%ud %.n]] pri-idx=file-pri-idx-my-table-3 data=file-data-my-table-3]]
++  row1
  [n=[p=%col3 q=20] l=[n=[p=%col2 q=28.242.037] l=~ r=~] r=[n=[p=%col1 q=1.685.221.219] l=~ r=~]]
++  row1-idx
  [~[1.685.221.219 20] row1]
++  row2
  [n=[p=%col3 q=0] l=[n=[p=%col2 q=0] l=~ r=~] r=[n=[p=%col1 q=32.770.348.699.510.084] l=~ r=~]]
++  row2-idx
...
++  file-data-my-table-3
  ~[row2 row1]
++  gen3-data
  [%data ship=~zod agent='/test-agent' tmsp=~2030.1.1 files=[n=file-my-table l=[n=gen3-file-my-table-3 l=~ r=~] r=~]]
::
++  gen3-db1-row
  [%db-row name=%db1 created-by-agent='/test-agent' created-tmsp=~2023.7.9..22.24.54..4b8a sys=~[gen2-intrnl gen1-intrnl gen0-intrnl] user-data=~[gen3-data gen2-data gen1-data gen0-data]]
++  gen3-dbs
[n=[p=%db1 q=gen3-db1-row] l=~ r=~]
::
++  row3
  [n=[p=%col3 q=21] l=[n=[p=%col2 q=1] l=~ r=~] r=[n=[p=%col1 q=216.433.586.019] l=~ r=~]]
++  row3-idx
  [~[216.433.586.019 21] row3]
++  row4
  [n=[p=%col3 q=1] l=[n=[p=%col2 q=182] l=~ r=~] r=[n=[p=%col1 q=216.433.586.019] l=~ r=~]]
++  row4-idx
  [~[216.433.586.019 1] row4]
++  gen4-file-pri-idx-my-table-3
  [n=row2-idx ~ r=[row4-idx l=[row1-idx ~ r=[row3-idx ~ ~]] ~]]
++  gen4-file-data-my-table-3
  ~[row4 row3 row2 row1]
++  gen4-file-my-table-3
  [p=[%dbo %my-table-3] q=[%file ship=~zod agent='/test-agent' tmsp=~2030.2.1 clustered=%.y length=4 column-lookup=col-lu-table-3 key=~[[%t %.y] [%ud %.n]] pri-idx=gen4-file-pri-idx-my-table-3 data=gen4-file-data-my-table-3]]
++  gen4-data
  [%data ship=~zod agent='/test-agent' tmsp=~2030.2.1 files=[n=file-my-table l=[n=gen4-file-my-table-3 l=~ r=~] r=~]]
++  gen4-db1-row
  [%db-row name=%db1 created-by-agent='/test-agent' created-tmsp=~2023.7.9..22.24.54..4b8a sys=~[gen2-intrnl gen1-intrnl gen0-intrnl] user-data=~[gen4-data gen3-data gen2-data gen1-data gen0-data]]
++  gen4-dbs
...
++  test-insert-db
  =|  run=@ud 
  =/  my-insert  "INSERT INTO db1..my-table-3 (col1, col2, col3) VALUES ('cord',~nomryg-nilref,20) ('Default',Default, 0)"
  =/  x  (process-cmds [start-dbs (bowl [run ~2030.1.1]) (parse:parse(default-database 'db1') my-insert)])
  ;:  weld
  %+  expect-eq                         
    !>    [%results ~[[%result-da msg='data time' date=~2030.1.1] [%result-ud msg='row count' count=2]]]         :: expected results
    !>  -.x
...
++  test-insert-no-cols
  =|  run=@ud 
  =/  my-insert  "INSERT INTO db1..my-table-3 VALUES ('cord2',~nec,21) ('cord2',~bus, 1)"
  =/  x  (process-cmds [gen3-dbs (bowl [run ~2030.2.1]) (parse:parse(default-database 'db1') my-insert)])
  ;:  weld
  %+  expect-eq                         
    !>    [%results ~[[%result-da msg='data time' date=~2030.2.1] [%result-ud msg='row count' count=2]]]         :: expected results
    !>  -.x
  %+  expect-eq                         :: expected state
    !>  gen4-dbs
    !>  +.x
...
++  test-fail-ins-no-cols-col-type
  ...
  %-  expect-fail
  |.  (process-cmds [gen3-dbs (bowl [run ~2030.2.1]) (parse:parse(default-database 'db1') my-insert)])
::
:: fail on dup rows
++  test-fail-insert-dup-rows
  ...
  =/  my-insert  "INSERT INTO db1..my-table-3 (col1, col2, col3) VALUES ('cord',~nomryg-nilref,20) ('Default',Default, 0)"
  %-  expect-fail
  |.  (process-cmds [gen3-dbs (bowl [run ~2031.1.1]) (parse:parse(default-database 'db1') my-insert)])
::
:: fail on dup col names
++  test-fail-insert-dup-cols
  =|  run=@ud
  =/  my-insert  "INSERT INTO db1..my-table-3 (col1, col2, col2) VALUES ('cord',~nomryg-nilref,20) ('Default',Default, 0)"
  %-  expect-fail
  |.  (process-cmds [start-dbs (bowl [run ~2031.1.1]) (parse:parse(default-database 'db1') my-insert)])
::
:: fail on too few cols
++  test-fail-insert-few-cols
  =|  run=@ud
  =/  my-insert  "INSERT INTO db1..my-table-3 (col1, col2) VALUES ('cord',~nomryg-nilref) ('Default',Default)"
  %-  expect-fail
  |.  (process-cmds [start-dbs (bowl [run ~2031.1.1]) (parse:parse(default-database 'db1') my-insert)])
::
...
++  test-fail-insert-more-cols
  =|  run=@ud
  =/  my-insert  "INSERT INTO db1..my-table-3 (col1, col2, col3, col4) VALUES ('cord',~nomryg-nilref,20, 1) ('Default',Default, 0, 2)"
  %-  expect-fail
  |.  (process-cmds [start-dbs (bowl [run ~2031.1.1]) (parse:parse(default-database 'db1') my-insert)])
::
...
++  test-fail-insert-col-type
  =|  run=@ud
  =/  my-insert  "INSERT INTO db1..my-table-3 (col1, col2, col3) VALUES (1,~nomryg-nilref,20) (2,Default, 0)"
  %-  expect-fail
  |.  (process-cmds [start-dbs (bowl [run ~2031.1.1]) (parse:parse(default-database 'db1') my-insert)])
::
...
++  test-fail-insert-col-name     
  =|  run=@ud
  =/  my-insert  "INSERT INTO db1..my-table-3 (col1a, col2, col3) VALUES ('cord',~nomryg-nilref,20) ('Default',Default, 0)"
  %-  expect-fail
  |.  (process-cmds [start-dbs (bowl [run ~2031.1.1]) (parse:parse(default-database 'db1') my-insert)])
::
...
++  test-fail-insert-tbl-name
  =|  run=@ud
  =/  my-insert  "INSERT INTO db1..my-table-2 (col1, col2, col3) VALUES ('cord',~nomryg-nilref,20) ('Default',Default, 0)"
  %-  expect-fail
  |.  (process-cmds [start-dbs (bowl [run ~2031.1.1]) (parse:parse(default-database 'db1') my-insert)])
::
...
++  test-fail-insert-ns-name
  =|  run=@ud
  =/  my-insert  "INSERT INTO db1.ns.my-table-3 (col1, col2, col3) VALUES ('cord',~nomryg-nilref,20) ('Default',Default, 0)"
  %-  expect-fail
  |.  (process-cmds [start-dbs (bowl [run ~2031.1.1]) (parse:parse(default-database 'db1') my-insert)])
::
::  select one literal 
