...
++  file-data-my-table-3
  ~[row2 row1]
++  gen3-data
  [%data ship=~zod agent=%agent tmsp=~2030.1.1 files=[n=file-my-table l=[n=gen3-file-my-table-3 l=~ r=~] r=~]]
::
++  gen3-db1-row
  [%db-row name=%db1 created-by-agent=%agent created-tmsp=~2023.7.9..22.24.54..4b8a sys=~[gen2-intrnl gen1-intrnl gen0-intrnl] user-data=~[gen3-data gen2-data gen1-data gen0-data]]
++  gen3-dbs
...
++  gen4-db1-row
  [%db-row name=%db1 created-by-agent=%agent created-tmsp=~2023.7.9..22.24.54..4b8a sys=~[gen2-intrnl gen1-intrnl gen0-intrnl] user-data=~[gen4-data gen3-data gen2-data gen1-data gen0-data]]
++  gen4-dbs
