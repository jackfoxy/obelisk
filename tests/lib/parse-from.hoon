...
++  test-from-join-19
  %+  expect-eq
  =/  expected
    [%transform ctes=~ [[%query from=[~ [%from object=foo-alias-y as-of=~ joins=~[[%joined-object join=%cross-join as-of=~ object=bar-alias-x predicate=~]]]] scalars=~ predicate=~ group-by=~ having=~ selection=select-all-columns order-by=~] ~ ~]]
      !>  ~[expected]
...
++  test-from-join-21
  %+  expect-eq
  =/  expected
    [%transform ctes=~ [[%query from=[~ [%from object=foo-unaliased as-of=~ joins=~[[%joined-object join=%cross-join as-of=~ object=bar-unaliased predicate=~]]]] scalars=~ predicate=~ group-by=~ having=~ selection=select-all-columns order-by=~] ~ ~]]
      !>  ~[expected]
...
++  test-from-join-22
  %+  expect-eq
  =/  expected
    [%transform ctes=~ [[%query from=[~ [%from object=passthru-row-y as-of=~ joins=~[[%joined-object join=%cross-join as-of=~ object=bar-alias-x predicate=~]]]] scalars=~ predicate=~ group-by=~ having=~ selection=select-all-columns order-by=~] ~ ~]]
      !>  ~[expected]
...
++  test-from-join-24
  %+  expect-eq
  =/  expected
    [%transform ctes=~ [[%query from=[~ [%from object=foo-alias-y as-of=~ joins=~[[%joined-object join=%cross-join as-of=~ object=passthru-row-x predicate=~]]]] scalars=~ predicate=~ group-by=~ having=~ selection=select-all-columns order-by=~] ~ ~]]
      !>  ~[expected]
...
++  test-from-join-26
  %+  expect-eq
  =/  expected
    [%transform ctes=~ [[%query from=[~ [%from object=passthru-unaliased as-of=~ joins=~[[%joined-object join=%cross-join as-of=~ object=passthru-unaliased predicate=~]]]] scalars=~ predicate=~ group-by=~ having=~ selection=select-all-columns order-by=~] ~ ~]]
      !>  ~[expected]
...
++  test-from-join-27
  %+  expect-eq
  =/  expected
    [%transform ctes=~ [[%query from=[~ [%from object=foo-alias-y as-of=~ joins=~[[%joined-object join=%cross-join as-of=~ object=passthru-unaliased predicate=~]]]] scalars=~ predicate=~ group-by=~ having=~ selection=select-all-columns order-by=~] ~ ~]]
      !>  ~[expected]
...
++  test-from-join-28
  %+  expect-eq
  =/  expected
    [%transform ctes=~ [[%query from=[~ [%from object=foo-unaliased as-of=~ joins=~[[%joined-object join=%join as-of=~ object=bar-unaliased predicate=~]]]] scalars=~ predicate=~ group-by=~ having=~ selection=select-all-columns order-by=~] ~ ~]]
      !>  ~[expected]
