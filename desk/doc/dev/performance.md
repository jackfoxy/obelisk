...
%obelisk-result:
  %results
    ...
    [ %relation-name 'animal-shelter.sys.tables' ]
    [ %schema-time ~2026.4.28..16.13.01..89bb ]
    [ %data-time ~2026.4.28..16.13.01..89bb ]
    [ %vector-count 25 ]
```
...
%obelisk-result:
  %results
    ...
    [ %relation-name 'animal-shelter.reference.calendar-us-fed-holiday' ]
    [ %schema-time ~2025.4.7..18.19.48..f509 ]
    [ %data-time ~2025.4.7..18.19.48..f509 ]
    [ %vector-count 10 ]
```
...
%obelisk-result:
  %results
    ...
    [ %schema-time ~2026.4.28..16.13.01..89bb ]
    [ %data-time ~2026.4.28..16.13.01..89bb ]
    [ %relation-name 'animal-shelter.reference.federal-holidays-fixed' ]
    [ %schema-time ~2026.4.28..16.13.01..89bb ]
    [ %data-time ~2026.4.28..16.13.01..89bb ]
    [ %vector-count 7.381 ]
...
%obelisk-result:
  %results
    ...
    [ %relation-name 'animal-shelter.reference.cities' ]
    [ %schema-time ~2026.4.28..16.13.01..89bb ]
    [ %data-time ~2026.4.28..16.13.01..89bb ]
    [ %relation-name 'animal-shelter.reference.city-zip-codes' ]
    [ %schema-time ~2026.4.28..16.13.01..89bb ]
    [ %data-time ~2026.4.28..16.13.01..89bb ]
    [ %vector-count 8.025 ]
```
...
%obelisk-result:
  %results
    ...
    [ %schema-time ~2026.4.28..16.13.01..89bb ]
    [ %data-time ~2026.4.28..16.13.01..89bb ]
    [ %relation-name 'animal-shelter.reference.federal-holidays-floating' ]
    [ %schema-time ~2026.4.28..16.13.01..89bb ]
    [ %data-time ~2026.4.28..16.13.01..89bb ]
    [ %vector-count 360 ]
```
