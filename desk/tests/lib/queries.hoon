          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.3]
              [%relation-name 'db2.dbo.my-table']
              [%schema-time ~2012.5.1]
              [%data-time ~2012.5.2]
              [%vector-count 3]
              ==
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.shrink-a']
              [%schema-time ~2012.5.1]
              [%data-time ~2012.5.2]
              [%relation-name 'db1.dbo.shrink-b']
              [%schema-time ~2012.5.1]
              [%data-time ~2012.5.2]
              [%vector-count 1]
              ==
...
++  expected-cross
      :~  %results
          ...
          [%server-time ~2012.5.3]
          [%relation-name 'db1.dbo.cross']
          [%schema-time ~2012.4.30]
          [%data-time ~2012.4.30]
          [%relation-name 'db1.dbo.tbl1']
          [%schema-time ~2012.4.30]
          [%data-time ~2012.4.30]
          [%vector-count 33]
          ==
  ...
  :*  run
      ...
      :-  %results
          :~  [%action 'SELECT']
              ...
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db2.dbo.holiday-calendar']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%vector-count 2]
              ==
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.nj-tbl-a']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db1.dbo.nj-tbl-b']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%vector-count 5]
              ==
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.nj-tbl-c']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db1.dbo.nj-tbl-d']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%vector-count 5]
              ==
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.tbl-a']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db1.dbo.tbl-b']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%vector-count 4]
              ==
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.adoptions']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db1.dbo.vaccinations']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%vector-count 3]
              ==
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2024.8.22..16.11.26]
              [%relation-name 'animal-shelter.dbo.adoptions']
              [%schema-time ~2024.8.22..15.31.46]
              [%data-time ~2024.8.22..15.31.46]
              [%relation-name 'animal-shelter.dbo.animals']
              [%schema-time ~2024.8.22..15.31.46]
              [%data-time ~2024.8.22..15.31.46]
              [%relation-name 'animal-shelter.dbo.animals-breed']
              [%schema-time ~2024.8.22..15.31.46]
              [%data-time ~2024.8.22..15.31.46]
              [%relation-name 'animal-shelter.dbo.persons']
              [%schema-time ~2024.8.22..15.31.46]
              [%data-time ~2024.8.22..15.31.46]
              [%relation-name 'animal-shelter.dbo.staff']
              [%schema-time ~2024.8.22..15.31.46]
              [%data-time ~2024.8.22..15.31.46]
              [%relation-name 'animal-shelter.dbo.vaccinations']
              [%schema-time ~2024.8.22..15.31.46]
              [%data-time ~2024.8.22..15.31.46]
              [%relation-name 'animal-shelter.reference.species-vaccines']
              [%schema-time ~2024.8.22..15.31.46]
              [%data-time ~2024.8.22..15.31.46]
              [%vector-count 3]
              ==
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.dept']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db1.dbo.emp']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%vector-count 4]
              ==
  ...
  :*  run
      ...
      :-  %results
          :~  [%action 'SELECT']
              [%result-set ~]
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.tiny-a']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db1.dbo.tiny-b']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%vector-count 0]
              ==
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.dept2']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db1.dbo.emp2']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%vector-count 4]
              ==
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.dept-small']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db1.dbo.emp']
              [%schema-time ~2012.4.30]
  ...
  :*  run
      ...
      :-  %results
          :~  [%action 'SELECT']
              ...
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db1.dbo.emp-small']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%vector-count 3]
              ==
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.dept-sm2']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db1.dbo.emp']
              [%schema-time ~2012.4.30]
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.date-catalog']
              [%schema-time ~2012.5.1]
              [%data-time ~2012.5.1]
              [%relation-name 'db1.sys.tables']
              [%schema-time ~2012.5.1]
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.ns-date-cat']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.compound-cat']
              [%schema-time ~2012.5.1]
              [%data-time ~2012.5.1]
              [%relation-name 'db1.sys.tables']
              [%schema-time ~2012.5.1]
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.ship-cat']
              [%schema-time ~2012.5.1]
              [%data-time ~2012.5.1]
              [%relation-name 'sys.sys.databases']
              [%schema-time ~2012.4.30]
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.date-ref-tbl']
              [%schema-time ~2012.5.1]
              [%data-time ~2012.5.1]
              [%relation-name 'db1.dbo.emp']
              [%schema-time ~2012.4.30]
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.tbl-cat-aof']
              [%schema-time ~2012.5.1]
              [%data-time ~2012.5.1]
              [%relation-name 'db1.sys.tables']
              [%schema-time ~2012.4.30]
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.partial-date-catalog']
              [%schema-time ~2012.5.1]
              [%data-time ~2012.5.1]
              [%relation-name 'db1.sys.tables']
              [%schema-time ~2012.5.1]
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.1]
              [%relation-name 'db1.dbo.cte-source']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db1.dbo.pet']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%vector-count 2]
              ==
          ...
          :~  [%action 'SELECT']
              :-  %result-set
                  :~  :-  %vector
                      ...
                      ==
              [%server-time ~2012.5.1]
              [%relation-name 'db1.dbo.join-cte-src']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db1.dbo.join-left']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db1.dbo.join-right']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%vector-count 2]
              ==
