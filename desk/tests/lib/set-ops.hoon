...
++  result-ab-union
  :-  %results
      :~  [%action 'SELECT']
          ...
          [%relation-name 'db1.dbo.same-a']
          [%schema-time ~2012.4.30]
          [%data-time ~2012.4.30]
          [%relation-name 'db1.dbo.same-b']
          [%schema-time ~2012.4.30]
          [%data-time ~2012.4.30]
          [%vector-count 4]
          ==
  ...
  :*  run
      ...
      :-  %results
          :~  [%action 'SELECT']
              ...
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.diff-name']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db1.dbo.diff-order']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db1.dbo.diff-type']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db1.dbo.same-a']
              [%schema-time ~2012.4.30]
  ...
  :*  run
      ...
      :-  %results
          :~  [%action 'SELECT']
              ...
              [%server-time ~2012.5.3]
              [%relation-name 'db1.dbo.dup-a']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%relation-name 'db1.dbo.dup-b']
              [%schema-time ~2012.4.30]
              [%data-time ~2012.4.30]
              [%vector-count 2]
              ==
