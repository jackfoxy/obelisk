...
++  test-alter-index-1
  ...
  =/  expected2
    :*  %alter-index
        [%qualified-table ship=~ database='db' namespace='dbo' name='my-index' ~]
...
++  test-alter-index-2
  =/  expected  [%alter-index name=[%qualified-table ship=~ database='db' namespace='ns' name='my-index' alias=~] object=[%qualified-table ship=~ database='db' namespace='ns' name='table' alias=~] columns=~[[%ordered-column name='col1' is-ascending=%.y]] action=%rebuild as-of=~]
  %+  expect-eq
    !>  ~[expected]
...
++  test-alter-index-4
  =/  expected  [%alter-index name=[%qualified-table ship=~ database='db1' namespace='dbo' name='my-index' alias=~] object=[%qualified-table ship=~ database='db1' namespace='dbo' name='table' alias=~] columns=~ action=%resume as-of=~]
  %+  expect-eq
    !>  ~[expected]
...
++  test-alter-table-03
  =/  expected  [%alter-table table=[%qualified-table ship=~ database='db1' namespace='dbo' name='table' alias=~] alter-columns=~ add-columns=~ drop-columns=['col1' 'col2' 'col3' ~] add-foreign-keys=~ drop-foreign-keys=~ as-of=~]
  %+  expect-eq
    !>  ~[expected]
...
++  test-alter-table-04
  =/  expected  [%alter-table table=[%qualified-table ship=~ database='db1' namespace='dbo' name='table' alias=~] alter-columns=~ add-columns=~ drop-columns=['col1' ~] add-foreign-keys=~ drop-foreign-keys=~ as-of=~]
  %+  expect-eq
    !>  ~[expected]
...
++  test-alter-table-06
  =/  expected  [%alter-table table=[%qualified-table ship=~ database='db1' namespace='dbo' name='mytable' alias=~] alter-columns=~ add-columns=~ drop-columns=~ add-foreign-keys=~ drop-foreign-keys=['fk1' 'fk2' ~] as-of=~]
  %+  expect-eq
    !>  ~[expected]
...
++  test-alter-table-07
  =/  expected  [%alter-table table=[%qualified-table ship=~ database='db' namespace='dbo' name='mytable' alias=~] alter-columns=~ add-columns=~ drop-columns=~ add-foreign-keys=~ drop-foreign-keys=['fk1' 'fk2' ~] as-of=~]
  %+  expect-eq
    !>  ~[expected]
...
:: drop 1 foreign key
++  test-alter-table-08
  =/  expected  [%alter-table table=[%qualified-table ship=~ database='db1' namespace='ns' name='mytable' alias=~] alter-columns=~ add-columns=~ drop-columns=~ add-foreign-keys=~ drop-foreign-keys=['fk1' ~] as-of=~]
  %+  expect-eq
    !>  ~[expected]
...
++  test-alter-table-15
  =/  expected  [%alter-table table=[%qualified-table ship=~ database='db1' namespace='dbo' name='table' alias=~] alter-columns=~ add-columns=~ drop-columns=['col1' 'col2' ~] add-foreign-keys=~ drop-foreign-keys=~ as-of=~]
  %+  expect-eq
    !>  ~[expected]
...
++  test-alter-table-16
  =/  expected  [%alter-table table=[%qualified-table ship=~ database='db1' namespace='dbo' name='table' alias=~] alter-columns=~ add-columns=~ drop-columns=['col1' ~] add-foreign-keys=~ drop-foreign-keys=~ as-of=[~ [%da ~2023.12.25..7.15.0..1ef5]]]
  %+  expect-eq
    !>  ~[expected]
...
++  test-alter-table-17
  =/  expected  [%alter-table table=[%qualified-table ship=~ database='db1' namespace='dbo' name='table' alias=~] alter-columns=~ add-columns=~ drop-columns=['col1' 'col2' 'col3' ~] add-foreign-keys=~ drop-foreign-keys=~ as-of=[~ %as-of-offset 5 %days]]
  %+  expect-eq
    !>  ~[expected]
...
++  test-alter-table-22
  =/  expected  [%alter-table table=[%qualified-table ship=~ database='db1' namespace='dbo' name='mytable' alias=~] alter-columns=~ add-columns=~ drop-columns=~ add-foreign-keys=~ drop-foreign-keys=['fk1' 'fk2' ~] as-of=[~ [%da ~2023.12.25..7.15.0..1ef5]]]
  %+  expect-eq
    !>  ~[expected]
...
++  test-alter-table-23
  =/  expected  [%alter-table table=[%qualified-table ship=~ database='db1' namespace='dbo' name='mytable' alias=~] alter-columns=~ add-columns=~ drop-columns=~ add-foreign-keys=~ drop-foreign-keys=['fk1' 'fk2' ~] as-of=[~ %as-of-offset 5 %days]]
  %+  expect-eq
    !>  ~[expected]
...
++  test-create-index-1
  =/  expected1  [%create-index name='my-index' object-name=[%qualified-table ship=~ database='db' namespace='ns' name='table' alias=~] is-unique=%.n columns=~[[%ordered-column name='col1' is-ascending=%.y] [%ordered-column name='col2' is-ascending=%.n] [%ordered-column name='col3' is-ascending=%.y]] as-of=~]
  =/  expected2  [%create-index name='my-index' object-name=[%qualified-table ship=~ database='db' namespace='dbo' name='table' alias=~] is-unique=%.y columns=~[[%ordered-column name='col1' is-ascending=%.y] [%ordered-column name='col2' is-ascending=%.n] [%ordered-column name='col3' is-ascending=%.y]] as-of=~]
  %+  expect-eq
    !>  ~[expected1 expected2]
...
++  test-create-index-2
  =/  expected  [%create-index name='my-index' object-name=[%qualified-table ship=~ database='db1' namespace='ns' name='table' alias=~] is-unique=%.n columns=~[[%ordered-column name='col1' is-ascending=%.y] [%ordered-column name='col2' is-ascending=%.n] [%ordered-column name='col3' is-ascending=%.y]] as-of=~]
  %+  expect-eq
    !>  ~[expected]
...
++  test-create-index-3
  =/  expected  [%create-index name='my-index' object-name=[%qualified-table ship=~ database='db1' namespace='dbo' name='table' alias=~] is-unique=%.n columns=~[[%ordered-column name='col1' is-ascending=%.n] [%ordered-column name='col2' is-ascending=%.y] [%ordered-column name='col3' is-ascending=%.y]] as-of=~]
  %+  expect-eq
    !>  ~[expected]
...
++  test-create-index-4
  =/  expected  [%create-index name='my-index' object-name=[%qualified-table ship=~ database='db1' namespace='dbo' name='table' alias=~] is-unique=%.y columns=~[[%ordered-column name='col1' is-ascending=%.n]] as-of=~]
  %+  expect-eq
    !>  ~[expected]
...
++  test-create-index-5
  =/  expected  [%create-index name='my-index' object-name=[%qualified-table ship=~ database='db1' namespace='dbo' name='table' alias=~] is-unique=%.y columns=~[[%ordered-column name='col1' is-ascending=%.y]] as-of=~]
  %+  expect-eq
    !>  ~[expected]
...
++  cte-foobar
  [%cte name='foobar' [%query [~ [%from relation=[%qualified-table ship=~ database='db1' namespace='dbo' name='foobar' alias=~] as-of=~ joins=~]] scalars=~ [%eq [col1 ~ ~] [[value-type=%ud value=2] ~ ~]] group-by=~ having=~ [%select top=~ columns=~[col3 col4]] ~]]
++  cte-bar
  [%cte name='bar' [%query [~ [%from relation=[%qualified-table ship=~ database='db1' namespace='dbo' name='bar' alias=~] as-of=~ joins=~]] scalars=~ [%eq [col1 ~ ~] [col2 ~ ~]] group-by=~ having=~ [%select top=~ columns=~[col2]] ~]]
++  foo-table
  [%qualified-table ship=~ database='db1' namespace='dbo' name='foo' alias=~]
++  foobar-table
  [%qualified-table ~ 'db1' 'dbo' 'foobar' ~]
++  foo-table-t1
  [%qualified-table ship=~ database='db1' namespace='dbo' name='foo' alias=[~ 'T1']]
::
...
++  test-drop-index-1
  =/  expected1  [%drop-index name='my-index' object=[%qualified-table ship=~ database='db' namespace='ns' name='name' alias=~] as-of=~]
  =/  expected2  [%drop-index name='my-index' object=[%qualified-table ship=~ database='db' namespace='dbo' name='name' alias=~] as-of=~]
  %+  expect-eq
    !>  ~[expected1 expected2]
...
++  test-drop-index-2
  %+  expect-eq
    !>  ~[[%drop-index name='my-index' object=[%qualified-table ship=~ database='other-db' namespace='ns' name='name' alias=~] as-of=~]]
...
:: tests 1, 2, 3, 5, and extra whitespace characters
++  test-drop-table-00
  =/  expected1  [%drop-table table=[%qualified-table ship=~ database='db' namespace='ns' name='name' alias=~] force=%.y as-of=~]
  =/  expected2  [%drop-table table=[%qualified-table ship=~ database='db' namespace='ns' name='name' alias=~] force=%.n as-of=~]
  %+  expect-eq
    !>  ~[expected1 expected2]
...
++  test-drop-table-01
  %+  expect-eq
    !>  ~[[%drop-table table=[%qualified-table ship=~ database='db' namespace='dbo' name='name' alias=~] force=%.y as-of=~]]
    !>  (parse:parse(default-database 'other-db') "   \09drop\0d\09  table\0aforce db..name ")
::
:: db..name
++  test-drop-table-02
  %+  expect-eq
    !>  ~[[%drop-table table=[%qualified-table ship=~ database='db' namespace='dbo' name='name' alias=~] force=%.n as-of=~]]
    !>  (parse:parse(default-database 'other-db') "drop table db..name")
::
:: force ns.name
++  test-drop-table-03
  %+  expect-eq
    !>  ~[[%drop-table table=[%qualified-table ship=~ database='other-db' namespace='ns' name='name' alias=~] force=%.y as-of=~]]
    !>  (parse:parse(default-database 'other-db') "drop table force ns.name")
::
:: ns.name
++  test-drop-table-04
  %+  expect-eq
    !>  ~[[%drop-table table=[%qualified-table ship=~ database='other-db' namespace='ns' name='name' alias=~] force=%.n as-of=~]]
    !>  (parse:parse(default-database 'other-db') "drop table ns.name")
::
:: force name
++  test-drop-table-05
  %+  expect-eq
    !>  ~[[%drop-table table=[%qualified-table ship=~ database='other-db' namespace='dbo' name='name' alias=~] force=%.y as-of=~]]
    !>  (parse:parse(default-database 'other-db') "DROP table FORCE name")
::
:: name
++  test-drop-table-06
  %+  expect-eq
   !>  ~[[%drop-table table=[%qualified-table ship=~ database='other-db' namespace='dbo' name='name' alias=~] force=%.n as-of=~]]
    !>  (parse:parse(default-database 'other-db') "DROP table name")
::
:: force db.ns.name as of now
++  test-drop-table-07
  %+  expect-eq
    !>  ~[[%drop-table table=[%qualified-table ship=~ database='db' namespace='ns' name='name' alias=~] force=%.y as-of=~]]
    !>  (parse:parse(default-database 'other-db') "drop table force db.ns.name as of now")
::
:: force db..name as of date
++  test-drop-table-08
  %+  expect-eq
    !>  ~[[%drop-table table=[%qualified-table ship=~ database='db' namespace='dbo' name='name' alias=~] force=%.y as-of=[~ [%da ~2023.12.25..7.15.0..1ef5]]]]
    !>  (parse:parse(default-database 'other-db') "drop table force db..name as of ~2023.12.25..7.15.0..1ef5")
::
:: force ns.name as of weeks ago
++  test-drop-table-09
  %+  expect-eq
    !>  ~[[%drop-table table=[%qualified-table ship=~ database='other-db' namespace='ns' name='name' alias=~] force=%.y as-of=[~ [%as-of-offset 10 %weeks]]]]
    !>  (parse:parse(default-database 'other-db') "drop table force ns.name as of 10 weeks ago")
::
:: name as of now
++  test-drop-table-10
  %+  expect-eq
    !>  ~[[%drop-table table=[%qualified-table ship=~ database='db' namespace='ns' name='name' alias=~] force=%.n as-of=~]]
    !>  (parse:parse(default-database 'other-db') "drop table db.ns.name as of now")
::
:: db..name as of date
++  test-drop-table-11
  %+  expect-eq
    !>  ~[[%drop-table table=[%qualified-table ship=~ database='db' namespace='dbo' name='name' alias=~] force=%.n as-of=[~ [%da ~2023.12.25..7.15.0..1ef5]]]]
    !>  (parse:parse(default-database 'other-db') "drop table db..name as of ~2023.12.25..7.15.0..1ef5")
::
:: name as of weeks ago
++  test-drop-table-12
  %+  expect-eq
    !>  ~[[%drop-table table=[%qualified-table ship=~ database='other-db' namespace='dbo' name='name' alias=~] force=%.n as-of=[~ [%as-of-offset 10 %weeks]]]]
...
:: tests 1, 2, 3, 5, and extra whitespace characters
++  test-drop-view-1
  =/  expected1  [%drop-view view=[%qualified-table ship=~ database='db' namespace='ns' name='name' alias=~] force=%.y]
  =/  expected2  [%drop-view view=[%qualified-table ship=~ database='db' namespace='ns' name='name' alias=~] force=%.n]
  %+  expect-eq
    !>  ~[expected1 expected2]
...
++  test-drop-view-2
  %+  expect-eq
    !>  ~[[%drop-view view=[%qualified-table ship=~ database='db' namespace='dbo' name='name' alias=~] force=%.y]]
    !>  (parse:parse(default-database 'other-db') "   \09drop\0d\09  vIew\0aforce db..name ")
::
:: db..name
++  test-drop-view-3
  %+  expect-eq
    !>  ~[[%drop-view view=[%qualified-table ship=~ database='db' namespace='dbo' name='name' alias=~] force=%.n]]
    !>  (parse:parse(default-database 'other-db') "drop view db..name")
::
:: force ns.name
++  test-drop-view-4
  %+  expect-eq
    !>  ~[[%drop-view view=[%qualified-table ship=~ database='other-db' namespace='ns' name='name' alias=~] force=%.y]]
    !>  (parse:parse(default-database 'other-db') "drop view force ns.name")
::
:: ns.name
++  test-drop-view-5
  %+  expect-eq
    !>  ~[[%drop-view view=[%qualified-table ship=~ database='other-db' namespace='ns' name='name' alias=~] force=%.n]]
    !>  (parse:parse(default-database 'other-db') "drop view ns.name")
::
:: force name
++  test-drop-view-6
  %+  expect-eq
    !>  ~[[%drop-view view=[%qualified-table ship=~ database='other-db' namespace='dbo' name='name' alias=~] force=%.y]]
    !>  (parse:parse(default-database 'other-db') "DROP VIEW FORCE name")
::
:: name
++  test-drop-view-7
  %+  expect-eq
    !>  ~[[%drop-view view=[%qualified-table ship=~ database='other-db' namespace='dbo' name='name' alias=~] force=%.n]]
...
++  test-truncate-table-01
  =/  expected1  [%truncate-table table=[%qualified-table ship=[~ ~zod] database='db' namespace='ns' name='name' alias=~] as-of=~]
  =/  expected2  [%truncate-table table=[%qualified-table ship=[~ ~sampel-palnet] database='db' namespace='dbo' name='name' alias=~] as-of=~]
  %+  expect-eq
    !>  ~[expected1 expected2]
...
++  test-truncate-table-02
  %+  expect-eq
    !>  ~[[%truncate-table table=[%qualified-table ship=~ database='db' namespace='ns' name='name' alias=~] as-of=~]]
    !>  (parse:parse(default-database 'dummy') "   \09truncate\0d\09  TaBle\0a db.ns.name ")
::
:: db..name
++  test-truncate-table-03
  %+  expect-eq
    !>  ~[[%truncate-table table=[%qualified-table ship=~ database='db' namespace='dbo' name='name' alias=~] as-of=~]]
    !>  (parse:parse(default-database 'dummy') "truncate table db..name")
::
:: ns.name
++  test-truncate-table-04
  %+  expect-eq
    !>  ~[[%truncate-table table=[%qualified-table ship=~ database='dummy' namespace='ns' name='name' alias=~] as-of=~]]
    !>  (parse:parse(default-database 'dummy') "truncate table ns.name")
::
:: name
++  test-truncate-table-05
  %+  expect-eq
   !>  ~[[%truncate-table table=[%qualified-table ship=~ database='dummy' namespace='dbo' name='name' alias=~] as-of=~]]
   !>  (parse:parse(default-database 'dummy') "truncate table name")
::
:: truncate as of now
++  test-truncate-table-06
  %+  expect-eq
    !>  ~[[%truncate-table table=[%qualified-table ship=~ database=%db1 namespace='dbo' name='tbl1' alias=~] as-of=~]]
...
++  test-truncate-table-07
  %+  expect-eq
    !>  ~[[%truncate-table table=[%qualified-table ship=~ database=%db1 namespace='dbo' name='tbl1' alias=~] as-of=[~ [%da ~2023.12.25..7.15.0..1ef5]]]]
...
++  test-truncate-table-08
  %+  expect-eq
    !>  ~[[%truncate-table table=[%qualified-table ship=~ database=%db1 namespace='dbo' name='tbl1' alias=~] as-of=[~ [%as-of-offset 4 %seconds]]]]
...
++  aliased-columns-1
  :~  [%unqualified-column column='x1' alias=[~ 'foo']]
      ...
      [%qualified-column qualifier=[%qualified-table ship=~ database='db1' namespace='dbo' name='table-alias' alias=~] column='name' alias=[~ 'bar']]
      [%qualified-column qualifier=[%qualified-table ship=~ database='db' namespace='dbo' name='table' alias=~] column='col2' alias=[~ 'bar2']]
      ...
      ==
++  mixed-all
  :~  [%all-object qualifier=[%qualified-table ship=~ database='db' namespace='dbo' name='t1' alias=~]]
      [%unqualified-column column='foo' alias=[~ 'foobar']]
      [%unqualified-column column='bar' alias=~]
      [%all %all]
      [%all-object qualifier=[%qualified-table ship=~ database='db1' namespace='dbo' name='t1' alias=[~ 'T1']]]
      ==
++  aggregates
...
++  from-t1
  [~ [%from relation=[%qualified-table ship=~ database='db1' namespace='dbo' name='t1' alias=[~ 'T1']] as-of=~ joins=~]]
++  from-aggregate
      :-  ~
          :^  %from
              relation=[%qualified-table ship=~ database='db1' namespace='dbo' name='tbl1' alias=~]
              as-of=~
              :~  :*  %joined-relation
                      join=%join
                      :*  %qualified-table
...
++  test-select-01
  =/  select  "select 0"
  %+  expect-eq
    !>  ~[[%selection ctes=~ [[%query ~ scalars=~ ~ group-by=~ having=~ [%select top=~ columns=~[[%selected-value [value-type=%ud value=0] ~]]] ~] ~ ~]]]
...
++  test-select-02
  ...
  %+  expect-eq
    !>  ~[[%selection ctes=~ [[%query ~ scalars=~ ~ group-by=~ having=~ [%select top=[~ 10] columns=~[[%all %all]]] ~] ~ ~]]]
    !>  (parse:parse(default-database 'db1') select)
::
::  star select top
++  test-select-03
...
++  test-select-08
  ...
  =/  from  :-  ~
                :^  %from
                    relation=[%qualified-table ship=~ database='db1' namespace='ns' name='table' alias=~]
                    as-of=~
                    :~  :*  %joined-relation
                            join=%join
                            :*  %qualified-table
  ...
  =/  my-columns
        :~  [%unqualified-column column='x1' alias=~]
            [%qualified-column qualifier=[%qualified-table ship=~ database='db1' namespace='ns' name='table' alias=~] column='col1' alias=~]
            [%qualified-column qualifier=[%qualified-table ship=~ database='db1' namespace='dbo' name='table-alias' alias=~] column='name' alias=~]
            [%qualified-column qualifier=[%qualified-table ship=~ database='db' namespace='dbo' name='table' alias=~] column='col2' alias=~]
            [%qualified-column qualifier=[%qualified-table ship=~ database='db' namespace='dbo' name='table' alias=[~ 'T1']] column='foo' alias=~]
            [%selected-value literal-1 ~]
            [%selected-value [value-type=%p value=0] ~]
            [%selected-value [value-type=%t value='cord'] ~]
            ==
  %+  expect-eq
    !>  ~[[%selection ctes=~ [[%query from scalars=~ ~ group-by=~ having=~ [%select top=[~ 10] columns=my-columns] ~] ~ ~]]]
    !>  (parse:parse(default-database 'db1') select)
::
...
++  test-select-09
  ...
  =/  my-columns
    :~  [%unqualified-column column='x1' alias=~]
        [%qualified-column qualifier=[%qualified-table ship=~ database='db' namespace='ns' name='foo' alias=~] column='col1' alias=~]
        [%qualified-column qualifier=[%qualified-table ship=~ database='db1' namespace='dbo' name='foo' alias=[~ 'T1']] column='name' alias=~]
        [%qualified-column qualifier=[%qualified-table ship=~ database='db1' namespace='dbo' name='foo' alias=~] column='col2' alias=~]
        [%qualified-column qualifier=[%qualified-table ship=~ database='db1' namespace='dbo' name='foo' alias=[~ 'T1']] column='foo' alias=~]
        [%selected-value literal-1 ~]
        [%selected-value [value-type=%p value=0] ~]
        [%selected-value [value-type=%t value='cord'] ~]
        ==
  ...
  =/  from  :-  ~
                :^  %from
                    ...
                    :~  :*  %joined-relation
                        ...
                        ==
  %+  expect-eq
    !>  ~[[%selection ctes=~ [[%query from scalars=~ ~ group-by=~ having=~ [%select top=~ columns=aliased-columns-1] ~] ~ ~]]]
    !>  (parse:parse(default-database 'db1') select)
::
  ...
  =/  from  :-  ~
                :^  %from
                    ...
                    :~  :*  %joined-relation
                        ...
                        ==
  %+  expect-eq
    !>  ~[[%selection ctes=~ [[%query from scalars=~ ~ group-by=~ having=~ [%select top=[~ 10] columns=aliased-columns-1] ~] ~ ~]]]
    !>  (parse:parse(default-database 'db1') select)
::
...
++  test-select-12
  ...
  %+  expect-eq
    !>  ~[[%selection ctes=~ [[%query from-t1 scalars=~ ~ group-by=~ having=~ [%select top=~ columns=mixed-all] ~] ~ ~]]]
    !>  (parse:parse(default-database 'db1') select)
::::
...
++  test-select-13
  ...
  %+  expect-eq
    !>  ~[[%selection ctes=~ [[%query from-t1 scalars=~ ~ group-by=~ having=~ [%select top=[~ 10] columns=mixed-all] ~] ~ ~]]]
    !>  (parse:parse(default-database 'db1') select)
...
++  test-group-by-01
  ...
  %+  expect-eq
    !>  ~[[%selection ctes=~ [[%query from-foo scalars=~ predicate=~ group-by=group-by having=~ select=select-all-columns order-by=~] ~ ~]]]
    !>  (parse:parse(default-database 'db1') select)
::
...
++  predicate-bar-eq-bar
  [%eq [[%qualified-column qualifier=[%qualified-table ship=~ database='UNKNOWN' namespace='COLUMN' name='tgt' alias=~] column='bar' alias=~] ~ ~] [[%qualified-column qualifier=[%qualified-table ship=~ database='UNKNOWN' namespace='COLUMN' name='src' alias=~] column='bar' alias=~] ~ ~]]
++  cte-bar-foobar
  [%cte name='T1' %query from=~ scalars=~ predicate=~ group-by=~ having=~ select=[%select top=~ columns=~[[%qualified-column qualifier=[%qualified-table ship=~ database='UNKNOWN' namespace='COLUMN-OR-CTE' name='bar' alias=~] column='bar' alias=~] [%qualified-column qualifier=[%qualified-table ship=~ database='UNKNOWN' namespace='COLUMN-OR-CTE' name='foobar' alias=~] column='foobar' alias=~]]] order-by=~]
++  cte-bar-foobar-src
  [%cte name='src' %query from=~ scalars=~ predicate=~ group-by=~ having=~ select=[%select top=~ columns=~[[%qualified-column qualifier=[%qualified-table ship=~ database='UNKNOWN' namespace='COLUMN-OR-CTE' name='bar' alias=~] column='bar' alias=~] [%qualified-column qualifier=[%qualified-table ship=~ database='UNKNOWN' namespace='COLUMN-OR-CTE' name='foobar' alias=~] column='foobar' alias=~]]] order-by=~]
++  column-src-foo
  [%qualified-column qualifier=[%qualified-table ship=~ database='UNKNOWN' namespace='COLUMN' name='src' alias=~] column='foo' alias=~]
++  column-src-bar
  [%qualified-column qualifier=[%qualified-table ship=~ database='UNKNOWN' namespace='COLUMN' name='src' alias=~] column='bar' alias=~]
++  column-src-foobar
...
::
++  q1  [%query from=~ scalars=~ predicate=~ group-by=~ having=~ select=[%select top=~ columns=s1] order-by=~]
++  q2  [%query from=~ scalars=~ predicate=~ group-by=~ having=~ select=[%select top=~ columns=s2] order-by=~]
++  q3  [%query from=~ scalars=~ predicate=~ group-by=~ having=~ select=[%select top=~ columns=s3] order-by=~]
::
...
++  s3b  ~[va-tar-fas-a]
::
++  q1a  [%query from=~ scalars=~ predicate=~ group-by=~ having=~ select=[%select top=~ columns=s1a] order-by=~]
++  q2a  [%query from=~ scalars=~ predicate=~ group-by=~ having=~ select=[%select top=~ columns=s2a] order-by=~]
++  q3a  [%query from=~ scalars=~ predicate=~ group-by=~ having=~ select=[%select top=~ columns=s3a] order-by=~]
++  q3b  [%query from=~ scalars=~ predicate=~ group-by=~ having=~ select=[%select top=~ columns=s3b] order-by=~]
::
