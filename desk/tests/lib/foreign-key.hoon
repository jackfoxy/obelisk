...
++  foreign-keys-result
  ...
  :-  %results
      :~  [%action 'SELECT']
          ...
          [%relation-name 'db1.sys.foreign-keys']
  ...
  :*  run
      ...
      :-  %results
          :~  [%action 'SELECT']
              ...
              [%relation-name 'db1.dbo.parent-a']
